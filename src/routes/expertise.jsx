...
const Expertise = ( props ) => {
    return (  
        <div className={ props.isMobile ? 'pl-4' : ''}>
            <h1 className="block mt-10 ml-6 sm:ml-0 text-[1.5rem] sm:text-xl font-semibold text-blue4">{ props.isMobile ? 'Expertise / Knowledge' : 'Field of Expertise'}</h1>
                                    ...
                                    <div className="pl-4">
                                        {
                                            expertise.tech.map(
                                                (tech, i) => {
                                                    return(
                                                        <div key={ i }>
                                                            <h3 className="relative z-10 pl-7 pt-2 text-[0.7rem] sm:text-sm font-medium text-gray-400
                                                            ...
                                                            <div className="pl-7">
                                                                <h3 className="text-[0.7rem] sm:text-sm font-medium text-gray-400 tracking-[0.03rem]">Level of Expertise: { tech.level }</h3>
                                                                <h3 className="text-[0.7rem] sm:text-sm font-medium text-gray-400 tracking-[0.03rem]">Year of Experience: { tech.years }</h3>
                                                            </div>
                                                        </div>
                                                    );
                                                }
